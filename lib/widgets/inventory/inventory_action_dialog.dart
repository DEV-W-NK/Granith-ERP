                ...
                children: [
                  ...
                  DropdownButtonFormField<Project>(
                    ...
                    decoration: InputDecoration(
                      labelText: isTransfer ? 'Para qual Obra? (Destino)' : 'Utilizado em qual Obra?',
                    ...
                    validator: isTransfer 
                        ? (val) => val == null ? 'Selecione a obra de destino' : null
                        : null, 
                  ),
                  if (!isTransfer)
                    const Padding(
                  ...
                  TextFormField(
                    ...
                    validator: (val) {
                      ...
                      if (qtd > widget.item.quantity) return 'Saldo insuficiente';
                      return null;
                    },
                  ),
      ...
      try {
        ...
        if (mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Movimentação registrada com sucesso!'), backgroundColor: AppColors.accentGreen),
          );
        }
      } catch (e) {
        if (mounted) {
